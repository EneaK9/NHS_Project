...
// const articles = JSON.parse(fs.readFileSync(join(__dirname, '../scraper/nhs_articles.json'), 'utf8')).slice(0, 5); // Limit to 5 articles // xh
...
translateArticles(); // Translate articles when the server starts
